...
router.group(() => {
  ...
  router.delete('/kategori/:id', '#controllers/kategori_controller.destroy').as('kategori.destroy')
  ...
  router.delete('/kampanye/:id', '#controllers/kampanye_controller.destroy').as('kampanye.destroy')
  ...
  router.delete('/donasi/:id', '#controllers/donasi_controller.destroy').as('donasi.destroy')
  ...
  router.delete('/donatur/:id', '#controllers/donatur_controller.destroy').as('donatur.destroy')
  router.get('/donatur/:id/history', '#controllers/donatur_controller.history').as('donatur.history')
  
  // Profile route
  router.get('/profile', ({ view }) => view.render('profile')).as('profile')
}).use(middleware.auth())
